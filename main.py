...
#####IMAGEM DO JOGO USANDA A BLIBLOTECA DO PYGAME#####
window = pygame.display.set_mode([1270, 720])
title = pygame.display.set_caption("PCA- JOGO PYTHON")
...
###### POSIÇÃO DOS JOGADORES E DA BOLA#######

player1 = pygame.image.load("assets/player1.jpg")
player1_y = 310
player1_moveup = False
player1_movedown = False

player2 = pygame.image.load("assets/player2.jpg")
player2_y = 310
...
#####LIMITES DO PLAYER NA TELA DE JOGO########
def move_player():
    global player1_y
...
#### VARIAVEL PARA MOVIMENTAR A BOLA E PONTUAÇÃO########
def move_ball():
    global ball_x
    global ball_y
    global ball_dir
...
##############MOVIMENTO DA BOLINHA NA TELA E PONTUAÇÃO##########
...
##### ESTRUTURA DE REPETIÇÃO  E MOVIMENTAÇÃO DO PLAYER 1 E 2 ########
loop = True
while loop:
